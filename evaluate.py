...
net.load_state_dict(torch.load("param5.pkl"))
test_iter = split_data(["./data/data_dir_028.pkl"], 10, 6)
...
test_list = count_valid_all(choose_threshold=0.1)
random.seed(2023)
random.shuffle(test_list)
CSI = evaluate(net, test_list,
